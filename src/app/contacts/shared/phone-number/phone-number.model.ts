...
export class PhoneNumber {
  ...
  private getFormattedPhoneNumberStr(
    format = 'default',
    countryCode?: string
  ): string {
  ...
  public getFormattedPhoneNumber(
    format = 'default',
    countryCode?: string
  ): string {
    ...
    if (countryCode && format) {
      internationalCountryCodeStr = this.getInternationCountryCodeStr(
        countryCode
      );
      formattedPhoneNumber = internationalCountryCodeStr
        ? `${internationalCountryCodeStr} ${formattedPhoneNumber}`
